...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'PaviaC':
        ...
        rgb_bands = (41, 21, 11)  # AVIRIS sensor
        ...
        ignored_labels = [0]
        # ignored_labels = [0]
    elif dataset_name == 'IndianPines8':
        #
        # Load the image
        img = open_file(folder + 'Indian_pines_corrected.mat')
        img = img['indian_pines_corrected']
        ...
        gt = open_file(folder + 'Indian_pines8_gt.mat')['gt']

        # 10249样本数据集
        # "1 Alfalfa 46", "2 Corn-notill 1428", "3 Corn-mintill 830",
        # "4 Corn 237", "5 Grass-pasture 483", "6 Grass-trees 730",
        # "7 Grass-pasture-mowed 28", "9 Hay-windrowed 478", "9 Oats 20",
        # "10 Soybean-notill 972", "11 Soybean-mintill 2455", "12 Soybean-clean 593",
        # "13 Wheat 205", "14 Woods 1265", "15 Buildings-Grass-Trees-Drives 386",
        # "16 Stone-Steel-Towers 93"
        label_values = ["Undefined", "Corn-notill", "Corn-mintill",
                        "Grass-pasture", "Hay-windrowed", "Soybean-notill",
