...
class MyNet(nn.Module):
    def __init__(self,out_dim,bands,seg_bands,patch_size=1,batch_size=128):
        ...
        self.conv2d1=nn.Sequential(
            nn.Conv2d(self.f_shape1[1],16,kernel_size=3),
            nn.BatchNorm2d(16),
            nn.ReLU()
        )
        ...
        fc_in=16*(self.f_shape1[2]-2)*(self.f_shape1[3]-2)
        ...
        self.num1=torch.tensor([1],dtype=torch.float32).to(device)
...
class Args():
    def __init__(self, data_name='Salinas'):
        self.method_name = 'twoBranch_newatt'
        #
        ...
        self.record = True
        self.recordFile = 'twoBranchnewatt_PU_results.txt'
...
if __name__ == '__main__':
    ...
    args.record=False
    args.method_name='two-PU-attless'
    args.patch_size=11
    args.base_nC=200
    # args.train_size=50
    # run(args)
